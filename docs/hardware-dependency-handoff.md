...
| HW-05 | JP41 BAUD0/U41.3 and JP42 BAUD1/U41.4 verified; 1-2=LOW, 2-3=HIGH. Actual shunts/remote rate and button map unknown; D40/learn qualification open | Keep baud=null and buttonMappingVerified=false; slot/epoch logic is not physical identification | RF-01/02 in external-box review; TX_ID framing, MODE_IND, learn/erase timing. U41.7 is grounded for momentary active-HIGH RF outputs |
